...
export const login = async (req, res) => {
  ...
  try {
    ...
    /**
     * 🛡️ MODERN SECURITY FIX
     * Use the fingerprint generated by our middleware to avoid triggering 
     * the 'req.ip' getter crash during sanitization.
     */
    ...
    res.cookie('refreshToken', refreshToken, {
      ...
      sameSite: 'none', // Mandatory for Vercel <-> Render communication
